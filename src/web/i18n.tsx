...
const zhToEn: Record<string, string> = {
  ...
  '上游端点：自动（跟随平台）': 'Upstream endpoint: auto (follow platform)',
  '指定该站点优先级最高的上游接口协议；仍保留其余候选作为回退。自动=跟随平台默认。': 'Preferred upstream protocol for this site; the remaining candidates stay as fallback. Auto = follow the platform default.',
  '账号': 'Accounts',
  '未关联站点': 'Unlinked Site',
  '余额': 'Balance',
  '令牌管理': 'Account Tokens',
