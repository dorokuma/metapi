...
export type RuntimeSettingsPayload = {
  ...
  notificationTemplates?: Record<string, Record<string, { title?: string; body?: string; parseMode?: '' | 'Markdown' | 'HTML' }>>;
  notificationTemplateVariablesByEvent?: Record<string, string[]>;
